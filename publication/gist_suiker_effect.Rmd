...
abstract: |
  Gist is voor mensen handig voor het maken van brood en alcohol, maar dan moet het wel effectief werken. In dit onderzoek, wordt er gekeken in welke suiker- en zoutconcentraties gist het meeste produceerd. Dit wordt gedaan door gist in verschillende suiker- en zoutconcentraties op te lossen en te kijken naar hoeveel CO2 de gist dan produceerd. Hieruit was te zien dat suiker een sterk effect heeft op de CO2 productie van gist, maar er met ons onderzoek niks met zekerheid te zeggen valt over zout. Het is ook onzeker of onze data wel bruikbaar is, omdat ***stukje discussie***
...
#source("../analysis/scripts/utilities.R")
...
suiker_lijn
zout_lijn
#box_figure <- ggarrange(suiker_lijn,zout_lijn,
...
```{r productie gemiddelde tabel, fig.cap="Gemiddelde gas productie in ml, "echo=FALSE}
...
```{r histogrammen, fig.cap="Histogrammen over de gasproductie hoeveelheden van gist in gas per ml. de aan de linker grafiek is voor de gist experimenten met variërende suiker concentraties en de rechter grafiek is voor de experimenten met variërende zout concentraties."}
