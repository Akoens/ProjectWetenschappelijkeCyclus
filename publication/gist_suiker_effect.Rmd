...
```{r histogrammen, echo=FALSE, fig.cap = "Histogrammen over de gasproductie hoeveelheden en hoe vaak ze voorkomen van gist in gas per ml.de aan de linker grafiek is voor de gist experimenten met variërende suiker concentraties en de rechter grafiek is voor de experimenten met variërende zout concentraties."}
...
box_figure
#labs(caption ="Histogrammen over de gasproductie hoeveelheden en hoe vaak ze voorkomen van gist in #gas per ml. de aan de linker grafiek is voor de gist experimenten met variërende suiker #concentraties en de rechter grafiek is voor de experimenten met variërende zout concentraties.")
...
kable(list(suiker_matrix, zout_matrix), caption = "test")
```
