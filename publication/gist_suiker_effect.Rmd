...
## Imputatie
Bij het experiment zijn er negatieve waardes gemeten, omdat dit met onze opzet niet mogelijk is duidt dit op een meetfout. Er is gekozen om imputatie toe te passen in de vorm van interpolatie op advies van Emil Appol. Dit is bij het suiker experiment 11 keer toegepast en bij zout 8 keer.  
