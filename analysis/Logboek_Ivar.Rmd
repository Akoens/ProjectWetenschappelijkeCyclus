...
test_suiker <- read.csv("../raw_data/Maatsheet Experiment Gist_suiker.csv")
test_zout <- read.csv("../raw_data/Maatsheet Experiment Gist_zout.csv")
#head(test_suiker)
#head(test_zout)
#boxplot(test_suiker$ , test_zout$CO...ml.)
```
...
suiker_data_ruw <- read.csv("../raw_data/Maatsheet Experiment Gist_Suiker.csv")
...
```{r head zout}
zout_data_ruw <- read.csv("../raw_data/Maatsheet Experiment Gist_Zout.csv")
head(zout_data_ruw)
```
...
### Commentaar over de data van dit experiment
Dit schrijf aan de hand van de ervaring bij het opstellen en afmeten van dit experiment en de data verwerking hiervan. ik vind dat er problemen zijn met de data die gegenereerd is. 
...
Commentaar voor eventuele opvolgers van dit experiment 
